...
import { MagneticButton } from "@calarys/ui";
import styles from "./page.module.css";
import { SpotlightCardDemo } from "../registry/spotlight-card";
      ...
      <ComponentShowcase
        items={[
...

          {
            ...
            component: (
              <>
                <ToggleDemo size="sm" shadow={true} /> <ToggleDemo size="md" />{" "}
                <ToggleDemo size="lg" shadow={true} />
              </>
            ),
          },
        ]}
